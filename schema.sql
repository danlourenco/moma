...
INSERT INTO exhibits (image_key, artist, details, title, year, medium, artist_statement, audio_key) 
VALUES ('seed2.jpg', 'R.A. Lourenço', 'Acquired from Storyheights Montessori Preschool', 'Test2', 2023, 'Crayon on Construction Paper', 'At first glance, one might underestimate the existential weight that this magnum opus carries. Undoubtedly, a playful yet poignant critique of the dichotomy between the structure of civilization and the chaos of natural order. Continued...', 'seed2.mp3');

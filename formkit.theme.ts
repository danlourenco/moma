...
/**
  ...
  *
  * @checksum - 805d0020494e4afcdc34b33110a2a32a6a4f2bc85c1a53ede9edb53994b7a3bd
  * @variables - radius=rounded,accentColor=sky,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "togglebuttons__input": {
    ...
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-sky-600": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-sky-600": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-sky-600": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-sky-600": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-sky-600": true,
    ...
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-sky-600": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-sky-600": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-sky-600": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-sky-600": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-sky-600": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-sky-600": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-sky-600": true
  },
